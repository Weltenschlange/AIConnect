...
- [ ] Parse the solution from constraint_solver into the proper JSON format
  - Example results.json format: `{ "puzzle_001": { "Person1": {"color": "red", "pet": "dog", "drink": "tea"}, "Person2": {...} }, ... }`
