...
* \[ ] Understand grid\_mode.parquet structure (1,000 logic grid puzzles)
* \[ ] Understand mc\_mode.parquet structure (3,259 multiple-choice questions)
...
* \[ ] Parse questions and check if the solution answers the question correctly
* \[✅] Validate that solutions generated by the solver are actually correct
* \[ ] Parse the solution from constraint\_solver into the proper JSON or CSV format (we dont know what format they actualy want now)
